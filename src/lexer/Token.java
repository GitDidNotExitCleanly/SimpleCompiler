...
public class Token {
	...
	public enum TokenClass {
		...
		// literals
		STRING_LITERAL, // \".*\" any sequence of characters enclosed in double
						// quote " (please be aware of the escape character
						// backslash \)
		NUMBER, // ('0'|...|'9')+
		CHARACTER, // \'('a'|...|'z'|'A'|...|'Z'|'\t'|'\n'|'.'|','|'_'|...)\' a
					// character starts and end with a single quote '
		...
		INVALID // in case we cannot recognise a character as part of a valid
				// token
	}
